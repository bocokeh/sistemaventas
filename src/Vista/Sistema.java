...
public final class Sistema extends javax.swing.JFrame {
    ...
    public Sistema (login priv){
        initComponents();
        jTabbedPane1.setEnabled(false); // Desactiva las pestañas pus nomas
        ...
        if (priv.getRol().equals("Asistente")) {
            ...
            LabelVendedor.setText("<html>Bienvenido<br>" + priv.getNombre() + "</html>");
        } else {
            LabelVendedor.setText("<html>Bienvenido<br>" + priv.getNombre() + "</html>");
        }
    ...
    public void ListarProductos() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                SwingUtilities.invokeLater(new Runnable() { // ACA ESTA EL HILO ESE
                    @Override
                    public void run() {
                        ...
                        TableProducto.setModel(modelo); // Se actualiza la tabla en el hilo de la interfaz gráfica
                    }
                });
            }
        }).start();
    ...
    private void btnGraficarActionPerformed(java.awt.event.ActionEvent evt) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Grafico.Graficar(fechaReporte); // Genera el gráfico en segundo plano
            }
        }).start();
    }
    ...
    private void txtCodigoVentaKeyPressed(java.awt.event.KeyEvent evt) {
        // Esto es para evita bloquear la UI mientras buscamos el producto o asi decia en el stackeo sobre corriente
        new Thread(new Runnable() {
            @Override
            public void run() {
                if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                    if (!"".equals(txtCodigoVenta.getText())) {
                        ...
                        pro = proDao.BuscarPro(cod); // Buscar el producto en segundo plano
                        SwingUtilities.invokeLater(new Runnable() {
                            @Override
                            public void run() {
    ...
    private void RegistrarVenta() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                RegistrarDetalle();  // Llamada al método de registrar detalles
            }
        }).start();
    }
    ...
    private void RegistrarDetalle() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                int cliente = Integer.parseInt(txtIdCV.getText());
                Vdao.pdfV(id, cliente, Totalpagar, LabelVendedor.getText());  // Genera el PDF después de registrar
            }
        }).start();
    }
